...
type StoredRun = { law:string; compilation:LawCompilation; state:WorldState; currentCrisis:GeneratedCrisis; mode:"live"|"continuity"; choices:string[]; token:string };
export function PlayRun() {
  ...
  return <DemoGame law={run.law} compilation={run.compilation} seed={run.state.seed} initialChoices={run.choices} initialState={run.state} initialCrisis={run.currentCrisis} continuity={run.mode === "continuity"} persist token={run.token} />;
}
